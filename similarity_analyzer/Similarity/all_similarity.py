...
image1_path = "vision_ai/similarity_test/images/torriden_3_blocks.png"
image2_path = "vision_ai/similarity_test/images/zgsi_3_blocks.png"
...
#
#===================================================================
save_path = 'vision_ai/similarity_test/images/'
for_ssim_image1 = cv2.cvtColor(image1, cv2.COLOR_BGR2GRAY)
for_ssim_image2 = cv2.cvtColor(image2, cv2.COLOR_BGR2GRAY)
cv2.imwrite('vision_ai/similarity_test/images/test1.png',for_ssim_image1)
cv2.imwrite('vision_ai/similarity_test/images/test2.png',for_ssim_image2)
