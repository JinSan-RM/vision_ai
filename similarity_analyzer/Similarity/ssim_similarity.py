...
def feature_matching(img1, img2):
    ...
    # ORB 파라미터 조정
    orb = cv2.ORB_create(nfeatures=500, scaleFactor=1, nlevels=8, edgeThreshold=0, firstLevel=0, WTA_K=2, scoreType=cv2.ORB_HARRIS_SCORE, patchSize=40, fastThreshold=30)
